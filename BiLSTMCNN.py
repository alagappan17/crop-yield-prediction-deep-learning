...
model = Sequential()
regressor.add(Bidirectional(LSTM(100, activation='relu',
              return_sequences=True, input_shape=(X_train.shape[1], 1))))  # elu
...
print("\n\n\n\nMean Square Error Bi LSTM CNN:\n")
print(MSE)
print("\nRoot Mean Square Error Bi LSTM CNN:\n")
print(RMSE)
print("\nMean Absolute Error Bi LSTM CNN:\n")
print(MAE)
print("\nR Squared Error Bi LSTM CNN:\n")
print(R2)

plt.plot(history.history['mse'])  # tb
plt.plot(history.history['val_mse'])
plt.title('Mean Squared Error - Bi LSTM CNN')
plt.ylabel('MSE')
plt.xlabel('epochs')
...
plt.title('Mean Absolute Error - Bi LSTM CNN')
plt.ylabel('MAE')
plt.xlabel('epochs')
plt.legend(['Training', 'Validation'], loc='upper left')
plt.show()

regressor.save("BiLSTMCNN.h5")
