...
print("\n\n\n\nMean Square Error Stacked LSTM CNN:\n")
print(MSE)
print("\nRoot Mean Square Error Stacked LSTM CNN:\n")
print(RMSE)
print("\nMean Absolute Error Stacked LSTM CNN:\n")
print(MAE)
print("\nR Squared Error Stacked LSTM CNN:\n")
print(R2)

plt.plot(history.history['mse'])  # tb
plt.plot(history.history['val_mse'])
plt.title('Mean Squared Error - Stacked LSTM CNN')
plt.ylabel('MSE')
plt.xlabel('epochs')
...
plt.title('Mean Absolute Error - Stacked LSTM CNN')
plt.ylabel('MAE')
plt.xlabel('epochs')
plt.legend(['Training', 'Validation'], loc='upper left')
plt.show()

regressor.save("StackedLSTMCNN.h5")
